      ...
      <CardActionArea onClick={onClick}>
        <CardContent style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Typography variant='body2' style={{ fontSize: 12, fontWeight: 'bolder' }}>{accessExpireTime}</Typography>
          </div>
        </CardContent>
      </CardActionArea>
    </Card>
  ...
  const Component =
    <Card sx={{ overflow: 'hidden' }}>
      <div style={{ background: contextApp.theme.palette.primary.main, padding: '20px 24px', color: 'rgba(255, 255, 255, 1)', display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
