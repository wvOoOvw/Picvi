              ...
              <>
                {
                  subscription.filter(i => i.noSale !== true).map((i, index) => {
                    return <div key={index} style={{ marginBottom: 12 }}>
                      <CardGroupCash name={i.name} price={i.price} description={i.description} accessExpireTime={i.accessExpireTime} onClick={() => { setSelectedOption(i); setStep(2); }} />
                    </div>
                  })
                }
              </>
              ...
              <>
                {
                  selectedOption ?
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      <CardGroupCash name={selectedOption.name} price={selectedOption.price} description={selectedOption.description} accessExpireTime={selectedOption.accessExpireTime} selected={true} />
                      <CardContactCash />
                    </div>
                    : null
                }
