...
function App() {
  ...
  const Component =
    <Dialog open={contextApp.dialogsArrayAction.exist('System')} onClose={() => contextApp.dialogsArrayAction.remove('System')} sx={{ '& .MuiDialog-paper': { width: 600, maxWidth: 'unset' } }}>
      ...
      <DialogContent style={{ paddingTop: 4, display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
        ...
        <Button variant='contained' onClick={onPickVideo}><CameraAltIcon style={{ marginRight: 4 }} />发布视频</Button>
      </DialogContent>
      <DialogActions>
