      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: 880 }}>
          ...
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 20, padding: 24 }}>
            ...
            <Typography style={{ fontSize: 12, opacity: 0.5, textAlign: 'center' }}>Picvi 内的所有内容都为在线浏览，无需下载或解压</Typography>

            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 8 }}>
              <Typography color='primary' style={{ fontSize: 20 }}>在线聊天</Typography>
              <Divider />
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <EntryCard
                iconComponent={<FavoriteIcon style={{ width: 24, height: 24, color: 'white' }} />}
                title='虚拟女友'
                subtitle='与你的 AI 女友对话'
                onClick={onAiChat}
              />
            </div>
