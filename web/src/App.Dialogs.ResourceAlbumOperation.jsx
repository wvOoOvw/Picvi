      ...
      <DialogContent style={{ paddingTop: 12 }}>
        {
          albumLoading !== true ?
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {step === 0 ? <StepName value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 1 ? <StepDescription value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 2 ? <StepTag value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 3 ? <StepActor value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 4 ? <StepPoster value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 5 ? <StepPreview value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 6 ? <StepSubscribeview value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
              {step === 7 ? <StepSetting value={album} onChange={setAlbum} optionTag={optionTag} optionActor={optionActor} type="album" /> : null}
            </div>
            : null
        }
        {
